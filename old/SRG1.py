if __name__ == "__main__":
    ...
    parser1.add_argument('--nLayers_HOSVD',type=int,default=0,help='Do HOSVD after SRG') 
    parser1.add_argument('--init_with_HOSVD',action='store_true',help='Use HOTRG to initialize weights') 
