...
# filename='data/hotrg_X24_torus_correlation_S1024_Y0.pkl'
# tensors_filename='data/hotrg_X24.pth'
# log2Size=10
# fix_y0=True
# y0=0

filename='data/hotrg_X24_torus_correlation_S1024_Y23.pkl'
tensors_filename='data/hotrg_X24.pth'
log2Size=10
fix_y0=True
y0=23

# filename='data/hotrg_gilt_X24_torus_correlation_S1024_Y0.pkl'
# tensors_filename='data/hotrg_gilt_X24.pth'
# log2Size=10
# fix_y0=True
# y0=0

# filename='data/hotrg_X24_torus_correlation_30.pkl'
# tensors_filename='data/hotrg_X24.pth'
# log2Size=30

# filename='data/hotrg_gilt_X24_torus_correlation_30.pkl'
# tensors_filename='data/hotrg_gilt_X24.pth'
# log2Size=30
...
for r in list(range(1,10))+list(np.geomspace(10,2**log2Size-1,max(2,data_count//2-10))):
    ...
    x0=0 if fix_x0 else np.random.randint(lattice_size[0]-r)
    y0=y0 if fix_y0 else np.random.randint(lattice_size[1])
    coordsss.append(((x0,y0),(x0+r,y0)))
